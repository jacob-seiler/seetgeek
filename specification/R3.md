...
#### Test Case R3.6.3 - /[GET] This page contains a form that a user can submit new tickets for sell which requests the field price
...
#### Test Case R3.6.3 - /[GET] This page contains a form that a user can submit new tickets for sellwhich requests the field expiration date
...
#### Test Case R3.7 - /[GET] This page contains a form that a user can buy new tickets that requests field quantity
