...
#### Test case R5.1 - /update[post] The name of the ticket has to be alphanumeric-only - positive
...
#### Test case R5.1 - /update[post] The name of the ticket has to be alphanumeric-only - negative
...
#### Test case R5.2 - /update[post] The name of the ticket is no longer than 60 characters  - positive
...
#### Test case R5.2 - /update[post] The name of the ticket is no longer than 60 characters  - negative
...
Actions:
 ...
 #### Test case R5.3 - /update[post] The quantity of the tickets has to be more than 0, and less than or equal to 100. - positive
...
Actions:
 ...
 #### Test case R5.3 - /update[post] The quantity of the tickets has to be more than 0, and less than or equal to 100. - negative
...
Actions:
 ...
 #### Test case R5.4 - /update[post] Price has to be of range [10, 100] - positive
...
Actions:
 ...
 #### Test case R5.4 - /update[post] Price has to be of range [10, 100] - negative
...
#### Test case R5.5 - /update[post] Date must be given in the format YYYYMMDD - positive
...
#### Test case R5.5 - /update[post] Date must be given in the format YYYYMMDD - negative
...
Actions:
 ...
 #### Test case R5.6 - /update[post] The ticket of the given name must exist - positive
...
Actions:
 ...
 #### Test case R5.6 - /update[post] The ticket of the given name must exist - negative
