...
#### Test case R6.1 - /buy[post] The name of the ticket has to be alphanumeric-only - positive
...
Actions:
 ...
 #### Test case R6.1 - /buy[post] The name of the ticket has to be alphanumeric-only - negative
...
Actions:
 ...
 #### Test case R6.2 - /buy[post] 	The name of the ticket is no longer than 60 characters - positive
...
Actions:
 ...
 #### Test case R6.2 - /buy[post] 	The name of the ticket is no longer than 60 characters - negative
...
Actions:
 ...
 #### Test case R6.3 - /buy[post] 	The quantity of the tickets has to be more than 0, and less than or equal to 100. - positive
...
Actions:
 ...
 #### Test case R6.3 - /buy[post] 	The quantity of the tickets has to be more than 0, and less than or equal to 100. - negative
...
Actions:
 ...
 #### Test case R6.4.1 - /buy[post] The quantity is more than the quantity requested to buy - negative
...
#### Test case R6.5 - /buy[post] The user has more balance than the ticket price * quantity + service fee (35%) + tax (5%) - positive
...
#### Test case R6.5 - /buy[post] The user has more balance than the ticket price * quantity + service fee (35%) + tax (5%) - negative
