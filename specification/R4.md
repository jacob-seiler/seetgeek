...
#### Test case R4.1 - /sell[post] The name of the ticket has to be alphanumeric-only - positive
...
#### Test case R4.1 - /sell[post] The name of the ticket has to be alphanumeric-only - negative
...
#### Test case R4.5 - /sell[post] Date must be given in the format YYYYMMDD - positive
...
#### Test case R4.5 - /sell[post] Date must be given in the format YYYYMMDD - negative
